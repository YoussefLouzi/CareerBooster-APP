...
public class AIService {
    ...
    private String constructGeneralAnalysisPrompt(String cvText) {
        return String.format("""
            You are a professional CV analyst. Analyze the following CV and provide a concise summary of its strengths and areas for improvement.

            Your response should be formatted as plain text, clearly separating the strengths and areas for improvement. Use bullet points or numbered lists for clarity if necessary, but do NOT include any JSON.

            Focus ONLY on the analysis of the CV's content, structure, and effectiveness in presenting the candidate's qualifications. Do NOT include course recommendations or any other information.
